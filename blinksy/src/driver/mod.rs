...
///
/// This trait, whether blocking or async, defines the common interface for sending
/// color data to LED hardware, regardless of the specific protocol or chipset being used.
///
/// # Type Parameters
///
